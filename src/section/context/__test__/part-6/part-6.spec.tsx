...
import ContextPart6 from '../../part-6';
...
describe(`Testing Part 6 Context Section`, () => {
  ...
  it(`Snapshot Testing`, async () => {
    const { container } = render(<ContextPart6 />);

    expect(container).toMatchSnapshot();
  });

  it(`Cell Item Should Be Updated`, async () => {
    const { getAllByTestId } = render(<ContextPart6 />);
  ...
  it(`All Cell Item Should Be Updated`, async () => {
    const { findByText, getAllByTestId } = render(<ContextPart6 />);
