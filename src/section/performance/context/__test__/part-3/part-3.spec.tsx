...
import ContextPart3 from '../../part-3';
...
describe(`Testing Part 3 Context Section`, () => {
  ...
  it(`Snapshot Testing`, async () => {
    const { container } = render(<ContextPart3 />);

    expect(container).toMatchSnapshot();
  });

  it(`Cell Item Should Be Updated`, async () => {
    const { getAllByTestId } = render(<ContextPart3 />);
  ...
  it(`All Cell Item Should Be Updated`, async () => {
    const { findByText, getAllByTestId } = render(<ContextPart3 />);
