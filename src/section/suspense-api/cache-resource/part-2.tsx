...
import { IPokemonCache } from './interface';
...
/**
 * Create Context & Custom Hooks
 */
const PokemonResourceCacheContext = createContext<IPokemonCache>(
  getPokemonSource
);
 ...
 * @since 2021.11.21
 */
export const usePokemonResourceCache = () =>
  useContext(PokemonResourceCacheContext);
...
export default CacheResourcePart2;
