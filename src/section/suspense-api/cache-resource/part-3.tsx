 ...
 * @since 2021.11.21
 */
const PokemonProvider: FC<IPokemonProviderProps> = (props) => {
...
/**
 * Part 3 Apps Wrap With Pokemon Provider
 * @author Irfan Andriansyah <irfan@99.co>
 * @since 2021.11.21
 */
const CacheResourcePart3WithCache: FC = () => (
  <PokemonProvider>
    <CacheResourcePart3 />
  </PokemonProvider>
);

export default CacheResourcePart3WithCache;
